...
#sizeModels=(1000^6)
declare -a sizeModels=( '100' '200' '500' '1000' )
#sizeModels=(1000^6)
declare -a mappers=( '1' '2' '4' )
#experiments folder
...
for index in `seq 0 $(( mLen-1))`  
	...
	java -cp ../dist-gen/fr.inria.atlanmod.dag.jar:$HADOOP_CLASSPATH fr.inria.atlanmod.dag.instantiator.Launcher -u $suff -n 1 -s ${sizeModels[$index]} -v 0.1 -e $seed -r $density 2>/dev/null
